...
This is the common Kumwe package release contract. Apply it to every package release.
...
`release-verified` and downstream adoption decisions under the package release verification contract.
